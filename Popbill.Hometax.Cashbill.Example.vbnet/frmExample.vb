'=========================================================================
' 팝빌 홈택스 현금영수증 API .NET SDK VB.NET Example
' VB.NET 연동 튜토리얼 안내 : https://developers.popbill.com/guide/htcashbill/dotnet/getting-started/tutorial?fwn=vb
'
' 업데이트 일자 : 2025-08-27
...
Public Class frmExample
    ...
    Private Sub btnRegistDeptUser_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnRegistDeptUser.Click
        ...
        Try
            Dim response As Response = htCashbillService.RegistDeptUser(txtCorpNum.Text, deptUserID, deptUserPWD, identityNum, userID)
    ...
    Private Sub btnGetRefundableBalance_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnGetRefundableBalance.Click
        ...
        Try
            Dim refundableBalance As Double = htCashbillService.GetRefundableBalance(txtCorpNum.Text, txtUserId.Text)
    ...
    Private Sub btnDeleteContact_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnDeleteContact.Click
        ...
        Try
            Dim response As Response = htCashbillService.DeleteContact(txtCorpNum.Text, targetUserID, txtUserId.Text)
