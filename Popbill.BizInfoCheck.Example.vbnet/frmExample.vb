'=========================================================================
' 팝빌 기업정보조회 API .NET SDK VB.NET Example
' VB.NET 연동 튜토리얼 안내 : https://developers.popbill.com/guide/bizinfocheck/dotnet/getting-started/tutorial?fwn=vb
'
' 업데이트 일자 : 2025-08-27
...
Public Class frmExample
    ...
    Private Sub btnCheckBizInfo_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnCheckBizInfo.Click
        ...
        Try
            ...
            tmp += "companyRegNum (법인등록번호): " + result.companyRegNum + vbCrLf
            tmp += "checkDT (기업정보조회일시) : " + result.checkDT + vbCrLf
    ...
    Private Sub btnUnitCost_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnUnitCost.Click
        Try
            ...
            MsgBox("unitCost(기업정보조회 단가) : " + unitCost.ToString)
    ...
    Private Sub btnGetRefundableBalance_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnGetRefundableBalance.Click
        ...
        Try
            Dim refundableBalance As Double = bizInfoCheckService.GetRefundableBalance(txtCorpNum.Text, txtUserId.Text)
    ...
    Private Sub btnDeleteContact_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnDeleteContact.Click
        ...
        Try
            Dim response As Response = bizInfoCheckService.DeleteContact(txtCorpNum.Text, targetUserID, txtUserId.Text)
