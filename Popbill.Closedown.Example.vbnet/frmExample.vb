...
Public Class frmExample
    ...
    Private Sub btnCheckCorpNum_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnCheckCorpNum.Click
        ...
        Try
            ...
            tmp += "typeDate (과세유형 전환일자) : " + corpStateInfo.typeDate + vbCrLf
    ...
    Private Sub btnGetRefundableBalance_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnGetRefundableBalance.Click
        ...
        Try
            Dim refundableBalance As Double = closedownService.GetRefundableBalance(txtCorpNum.Text, txtUserId.Text)
    ...
    Private Sub btnDeleteContact_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnDeleteContact.Click
        ...
        Try
            Dim response As Response = closedownService.DeleteContact(txtCorpNum.Text, targetUserID, txtUserId.Text)
