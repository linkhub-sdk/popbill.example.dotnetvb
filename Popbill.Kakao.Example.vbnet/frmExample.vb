'=========================================================================
' 팝빌 카카오톡 API .NET SDK VB.NET Example
' VB.NET 연동 튜토리얼 안내 : https://developers.popbill.com/guide/kakaotalk/dotnet/getting-started/tutorial?fwn=vb
'
' 업데이트 일자 : 2025-07-23
...
Public Class frmExample
    ...
    Private Sub btnDeleteContact_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnDeleteContact.Click
        ...
        Try
            Dim response As Response = kakaoService.DeleteContact(txtCorpNum.Text, targetUserID, txtUserId.Text)
