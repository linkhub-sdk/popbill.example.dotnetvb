'=========================================================================
' 팝빌 문자 API .NET SDK VB.NET Example
' VB.NET 연동 튜토리얼 안내 : https://developers.popbill.com/guide/sms/dotnet/getting-started/tutorial?fwn=vb
'
' 업데이트 일자 : 2025-08-27
...
Public Class frmExample
    ...
    Private Sub btnGetSenderNumberList_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnGetSenderNumberList.Click
        Try
            ...
            Dim tmp As String = "number(발신번호) | representYN(대표번호여부) | state(등록상태) | memo(메모)" + vbCrLf
    ...
    Private Sub btnUnitCost_SMS_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnUnitCost_SMS.Click
        ...
        Try
            ...
            MsgBox("unitCost(단문 전송단가) : " + unitCost.ToString)
    ...
    Private Sub btnGetUnitCost_LMS_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnGetUnitCost_LMS.Click
        ...
        Try
            ...
            MsgBox("unitCost(장문 전송단가) : " + unitCost.ToString)
    ...
    Private Sub btnGetUnitCost_MMS_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnGetUnitCost_MMS.Click
        ...
        Try
            ...
            MsgBox("unitCost(포토문자 전송단가) : " + unitCost.ToString)
    ...
    Private Sub btnGetRefundableBalance_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnGetRefundableBalance.Click
        ...
        Try
            Dim refundableBalance As Double = messageService.GetRefundableBalance(txtCorpNum.Text, txtUserId.Text)
    ...
    Private Sub btnDeleteContact_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnDeleteContact.Click
        ...
        Try
            Dim response As Response = messageService.DeleteContact(txtCorpNum.Text, targetUserID, txtUserId.Text)
