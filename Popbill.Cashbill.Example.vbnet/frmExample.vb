'=========================================================================
' 팝빌 현금영수증 API .NET SDK VB.NET Example
' VB.NET 연동 튜토리얼 안내 : https://developers.popbill.com/guide/cashbill/dotnet/getting-started/tutorial?fwn=vb
'
' 업데이트 일자 : 2025-07-23
...
Public Class frmExample
    ...
    Private Sub btnRegistIssue_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnRegistIssue.Click
        ...
        Try
            ...
            MsgBox("code(응답코드) : " + response.code.ToString + vbCrLf + "message(응답메시지) : " + response.message + vbCrLf _
                   + "confirmNum(국세청 승인번호) : " + response.confirmNum + vbCrLf + "tradeDate(거래일자) : " + response.tradeDate)
        Catch ex As PopbillException
            MsgBox("code(응답코드) : " + ex.code.ToString + vbCrLf + "message(응답메시지) : " + ex.Message)
        End Try
    End Sub
    ...
    Private Sub btnGetInfo_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnGetInfo.Click
        Try
            ...
            tmp += "ntsresultMessage (국세청 결과메시지) : " + cbInfo.ntsresultMessage + vbCrLf
    ...
    Private Sub btnGetUnitCost_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnGetUnitCost.Click
        Try
            ...
            MsgBox("unitCost(현금영수증 발행단가) : " + unitCost.ToString)
    ...
    Private Sub btnGetRefundableBalance_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnGetRefundableBalance.Click
        ...
        Try
            Dim refundableBalance As Double = cashbillService.GetRefundableBalance(txtCorpNum.Text, txtUserId.Text)
    ...
    Private Sub btnDeleteContact_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnDeleteContact.Click
        ...
        Try
            Dim response As Response = cashbillService.DeleteContact(txtCorpNum.Text, targetUserID, txtUserId.Text)
